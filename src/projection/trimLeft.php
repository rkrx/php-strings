 ...
 * @param string|null $chars The characters to remove from the beginning of the string. When null, only whitespace will be removed.
 * @return string|null The trimmed string or null, if the input was null.
 */
function trimLeft(?string $string, ?string $chars = null): ?string {
	if($string === null) {
		return null;
	}
	if($chars === null) {
